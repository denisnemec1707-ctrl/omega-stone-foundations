       ...
       <div className="container mx-auto px-5 sm:px-6 md:px-8 lg:px-16">
         ...
         <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8 md:gap-12 lg:gap-16">
           <div className="text-center p-2 sm:p-0">
             <p className="font-serif text-2xl sm:text-4xl md:text-display-sm text-gold mb-2 sm:mb-3 md:mb-4">10%</p>
           ...
           <div className="text-center p-2 sm:p-0">
             <p className="font-serif text-2xl sm:text-4xl md:text-display-sm text-gold mb-2 sm:mb-3 md:mb-4">20%+</p>
