...
const HowItWorks = () => {
  return (
    <section id="ako-to-funguje" className="py-20 md:py-32 lg:py-48">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-10 md:space-y-16">
            <div className="flex gap-5 md:gap-8">
              <div className="flex-shrink-0 w-12 h-12 md:w-16 md:h-16 rounded-full border border-gold flex items-center justify-center">
                <span className="font-serif text-xl md:text-2xl text-gold">1</span>
              </div>
              <div>
                <h3 className="font-serif text-xl md:text-2xl mb-3 md:mb-4">Investujete</h3>
            ...
            <div className="flex gap-5 md:gap-8">
              <div className="flex-shrink-0 w-12 h-12 md:w-16 md:h-16 rounded-full border border-border flex items-center justify-center">
                <span className="font-serif text-xl md:text-2xl text-muted-foreground">2</span>
              </div>
              <div>
                <h3 className="font-serif text-xl md:text-2xl mb-3 md:mb-4">Kupujeme nehnuteľnosť</h3>
                <p className="text-muted-foreground font-light text-sm md:text-base leading-relaxed">
            ...
            <div className="flex gap-5 md:gap-8">
              <div className="flex-shrink-0 w-12 h-12 md:w-16 md:h-16 rounded-full border border-border flex items-center justify-center">
                <span className="font-serif text-xl md:text-2xl text-muted-foreground">3</span>
              </div>
              <div>
                <h3 className="font-serif text-xl md:text-2xl mb-3 md:mb-4">Rekonštrukcia a predaj</h3>
                <p className="text-muted-foreground font-light text-sm md:text-base leading-relaxed">
            ...
            <div className="flex gap-5 md:gap-8">
              <div className="flex-shrink-0 w-12 h-12 md:w-16 md:h-16 rounded-full border border-gold flex items-center justify-center">
                <span className="font-serif text-xl md:text-2xl text-gold">4</span>
              </div>
              <div>
                <h3 className="font-serif text-xl md:text-2xl mb-3 md:mb-4">Dostávate výnosy</h3>
                <p className="text-muted-foreground font-light text-sm md:text-base leading-relaxed">
