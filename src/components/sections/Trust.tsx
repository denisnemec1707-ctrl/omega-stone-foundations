        ...
        <div className="max-w-4xl mx-auto">
           ...
           <div className="grid sm:grid-cols-2 gap-6 sm:gap-8 md:gap-12 mb-8 sm:mb-12 md:mb-16">
             <div className="border-l-2 border-gold pl-4 sm:pl-6 md:pl-8">
               <h3 className="font-serif text-lg sm:text-xl md:text-2xl mb-2 sm:mb-3 md:mb-4">Konzervatívna akvizícia</h3>
             ...
             <div className="border-l border-border pl-4 sm:pl-6 md:pl-8">
               <h3 className="font-serif text-lg sm:text-xl md:text-2xl mb-2 sm:mb-3 md:mb-4">Zabezpečenie reálnymi aktívami</h3>
               <p className="text-muted-foreground font-light text-xs sm:text-sm md:text-base leading-relaxed">
             ...
             <div className="border-l border-border pl-4 sm:pl-6 md:pl-8">
               <h3 className="font-serif text-lg sm:text-xl md:text-2xl mb-2 sm:mb-3 md:mb-4">Krátke cykly</h3>
               <p className="text-muted-foreground font-light text-xs sm:text-sm md:text-base leading-relaxed">
             ...
             <div className="border-l border-border pl-4 sm:pl-6 md:pl-8">
               <h3 className="font-serif text-lg sm:text-xl md:text-2xl mb-2 sm:mb-3 md:mb-4">Prevádzkové skúsenosti</h3>
               <p className="text-muted-foreground font-light text-xs sm:text-sm md:text-base leading-relaxed">
