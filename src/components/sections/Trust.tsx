       ...
       <div className="container mx-auto px-5 sm:px-6 md:px-8 lg:px-16">
        <div className="max-w-4xl mx-auto">
           <div className="text-center mb-8 sm:mb-10 md:mb-16">
             ...
             <h2 className="font-serif text-2xl sm:text-3xl md:text-display-sm lg:text-display-md mb-4 sm:mb-6 md:mb-8 text-foreground">
           ...
           <div className="grid sm:grid-cols-2 gap-6 sm:gap-8 md:gap-12 mb-8 sm:mb-12 md:mb-16">
             <div className="border-l-2 border-gold pl-4 sm:pl-6 md:pl-8">
               <h3 className="font-serif text-lg sm:text-xl md:text-2xl mb-2 sm:mb-3 md:mb-4 text-foreground">Konzervatívna akvizícia</h3>
             ...
             <div className="border-l border-border pl-4 sm:pl-6 md:pl-8">
               <h3 className="font-serif text-lg sm:text-xl md:text-2xl mb-2 sm:mb-3 md:mb-4 text-foreground">Zabezpečenie reálnymi aktívami</h3>
               <p className="text-muted-foreground font-light text-xs sm:text-sm md:text-base leading-relaxed">
             ...
             <div className="border-l border-border pl-4 sm:pl-6 md:pl-8">
               <h3 className="font-serif text-lg sm:text-xl md:text-2xl mb-2 sm:mb-3 md:mb-4 text-foreground">Krátke cykly</h3>
               <p className="text-muted-foreground font-light text-xs sm:text-sm md:text-base leading-relaxed">
             ...
             <div className="border-l border-border pl-4 sm:pl-6 md:pl-8">
               <h3 className="font-serif text-lg sm:text-xl md:text-2xl mb-2 sm:mb-3 md:mb-4 text-foreground">Prevádzkové skúsenosti</h3>
               <p className="text-muted-foreground font-light text-xs sm:text-sm md:text-base leading-relaxed">
