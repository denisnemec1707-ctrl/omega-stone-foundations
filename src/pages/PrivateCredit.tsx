      ...
      <main>
        ...
        <section className="py-12 sm:py-20 md:py-32 border-t border-border">
          <div className="container mx-auto px-5 sm:px-6 md:px-8 lg:px-16">
            ...
            <StaggerContainer className="grid md:grid-cols-2 gap-4 sm:gap-8 lg:gap-12 max-w-5xl mx-auto" staggerDelay={0.15}>
              {financingTypes.map((type, index) => (
                <StaggerItem key={index}>
                  <motion.div 
                    className="bg-card p-5 sm:p-8 lg:p-10 border border-border shadow-sm h-full"
