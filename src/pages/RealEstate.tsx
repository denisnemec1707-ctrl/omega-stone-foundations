...
const faqs = [
  {
    ...
    answer: "Náš výnos pochádza zo ziskovej marže na realitných transakciách. Akvizujeme nehnuteľnosti minimálne 20% pod trhovou hodnotou, rekonštruujeme ich a predávame za férovú trhovú cenu.",
  },
  {
    question: "Je moja investícia zabezpečená nehnuteľnosťami?",
    answer: "Áno. Každé euro, ktoré investujete, je nasadené do akvizície fyzických nehnuteľností. Celý kapitálový fond je zabezpečený realitnými aktívami.",
  },
  {
    question: "Aký je typický investičný horizont?",
    answer: "Štandardné investičné obdobia sa pohybujú od 12 do 18 mesiacov. Na konci každého obdobia sa vám vráti celá istina spolu so všetkými získanými výnosmi.",
  },
  {
    question: "Ako a kedy sa vyplácajú výnosy?",
    answer: "Výnosy sa vyplácajú mesačne, priamo na váš bankový účet. Vaša mesačná výplata sa vypočíta ako 1/12 vášho ročného výnosu.",
  },
  {
    question: "Aké sú riziká investície?",
    answer: "Primárne riziko je spojené s podmienkami na realitnom trhu. Toto zmierňujeme konzervatívnou akvizíciou — kupujeme iba nehnuteľnosti výrazne pod trhovou hodnotou.",
  },
  {
    question: "Aká je minimálna výška investície?",
    answer: "Minimálna investícia je 10 000 €. Väčšie investície môžu kvalifikovať na dodatočné podmienky.",
  },
  {
    question: "Môžem vybrať investíciu predčasne?",
    answer: "Investície sú viazané na dohodnuté obdobie. V mimoriadnych prípadoch môžeme vyhovieť žiadostiam s poplatkom za predčasný výstup.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        {/* Why Invest */}
        <SectionBlock
          label="Výhody pre investorov"
          title="Prečo investovať"
          titleAccent="s ASSETRA"
          description="Ponúkame jednoduchý investičný model s jasnými podmienkami, predvídateľnými výnosmi a zabezpečením reálnymi aktívami."
        >
        ...
        <SectionBlock
          dark
          label="O ASSETRA investments"
          title="Špecialisti na realitné"
          titleAccent="akvizície"
          description="Náš tím identifikuje núdzové predaje, likvidácie dedičstiev a motivovaných predajcov."
        >
          <div className="space-y-4 md:space-y-6 text-primary-foreground/60 font-light text-sm sm:text-base md:text-lg leading-relaxed max-w-3xl">
            <p>
            ...
            <p>
              Nehnuteľnosti rekonštruujeme na trhový štandard a predávame za férovú trhovú hodnotu. Nešpekulujeme na trhových pohyboch. Kupujeme reálne nehnuteľnosti, zhodnocujeme ich a predávame.
            </p>
          </div>
        </SectionBlock>
        ...
        {/* How It Works */}
        <SectionBlock
          label="Investičný model"
          title="Ako váš kapitál"
          titleAccent="pracuje"
        >
        ...
        <SectionBlock
          dark
          label="Riadenie rizík"
          title="Ochrana kapitálu"
          titleAccent="na prvom mieste"
          description="Každú transakciu štruktúrujeme s bezpečnosťou vášho kapitálu ako primárnou prioritou."
        >
        ...
        <SectionBlock
          id="kalkulacka"
          label="Investičná kalkulačka"
          title="Vypočítajte si svoje"
          titleAccent="výnosy"
        >
          <AnimatedSection delay={0.2}>
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16">
              ...
              <motion.div className="bg-card p-5 sm:p-8 md:p-10 border border-border" initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                <h3 className="font-serif text-lg sm:text-xl mb-6 sm:mb-8 text-center">Vaše výnosy</h3>
                <div className="space-y-6 sm:space-y-8">
                  <div className="text-center pb-6 border-b border-border">
                    <p className="text-xs sm:text-sm tracking-wide uppercase text-muted-foreground mb-1">Mesačná výplata</p>
                  ...
                  <div className="text-center pb-6 border-b border-border">
                    <p className="text-xs sm:text-sm tracking-wide uppercase text-muted-foreground mb-1">Celkový výnos</p>
                    <p className="font-serif text-2xl sm:text-3xl"><AnimatedValue value={calculations.totalReturn} formatValue={formatCurrency} /></p>
                  </div>
                  <div className="text-center">
                    <p className="text-xs sm:text-sm tracking-wide uppercase text-muted-foreground mb-1">Celkom na konci</p>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">(Istina + Výnosy)</p>
                  </div>
                </div>
              </motion.div>
            </div>
        ...
        <section id="kontakt" className="py-16 sm:py-24 md:py-32">
          <div className="container mx-auto px-5 sm:px-6 md:px-8 lg:px-12 xl:px-20">
            <AnimatedSection className="mb-10 sm:mb-14">
              <p className="text-xs sm:text-sm tracking-ultra-wide uppercase text-muted-foreground mb-3">Začnite investovať</p>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16">
              <AnimatedSection delay={0.1}>
                <div className="bg-card p-5 sm:p-8 md:p-10 border border-border">
                  <h3 className="font-serif text-xl mb-6 sm:mb-8">Žiadosť o informácie</h3>
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    <div>
                      <label className="text-xs sm:text-sm tracking-wide uppercase text-muted-foreground mb-2 block">Meno a priezvisko *</label>
                    ...
                    <div>
                      <label className="text-xs sm:text-sm tracking-wide uppercase text-muted-foreground mb-2 block">Plánovaná investícia</label>
                      <Input {...register("investmentAmount")} placeholder="napr. 50 000 €" className="bg-background border-border focus:border-primary h-11 md:h-12" />
                    </div>
                    <div>
                      <label className="text-xs sm:text-sm tracking-wide uppercase text-muted-foreground mb-2 block">Správa *</label>
                      <Textarea {...register("message")} placeholder="Vaše investičné ciele alebo otázky..." rows={4} className="bg-background border-border focus:border-primary resize-none" />
              ...
              <AnimatedSection delay={0.2} className="flex flex-col justify-between">
                <div>
                  ...
                  <div className="space-y-6 sm:space-y-8">
                    ...
                    <div>
                      <p className="text-xs sm:text-sm tracking-wide uppercase text-muted-foreground mb-2">Telefón</p>
                      <a href="tel:+421212345678" className="text-lg sm:text-xl hover:text-primary transition-colors">+421 2 123 456 78</a>
                    </div>
                    <div>
